...
// --- Template Installer Component (FIXED) ---
...
  
  useEffect(() => {
    const templatesRef = collection(db, 'platform_templates');
...
      setLoading(false);
    }, (err) => {
      console.error("Error fetching platform templates:", err);
...
      id: newModuleId.toLowerCase().replace(/\s+/g, '_'),
      name: newModuleName,
      icon: newModuleIcon,
